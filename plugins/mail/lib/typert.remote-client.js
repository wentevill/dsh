...
const dsh_mail_plugin_mailSettings_load_result$schema = z.object({
  'settings': z.object({
  'username': z.string(),
  ...
  descriptors: [
    {
      ...
      sourceLocation: {"file":"packages/mail/src/index.ts","line":53,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/mail/src/index.ts","line":61,"column":9},
    },
  ],
}
