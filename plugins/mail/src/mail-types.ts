import type {
  MailAddress as UpstreamMailAddress,
  MailAttachmentMetadata as UpstreamMailAttachmentMetadata,
  MailListRequest as UpstreamMailListRequest,
  MailListResult as UpstreamMailListResult,
