...
export type CronCreateRequest = CronCreateInput & { readonly sessionId: SessionId }
...
export type CronDefinitionWire = {
  ...
  | { readonly executionMode: 'existing_session'; readonly targetSessionId: string }
  | { readonly executionMode: 'new_session'; readonly agentPresetId: string }
)
